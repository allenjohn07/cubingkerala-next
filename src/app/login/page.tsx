...
export default function Login() {
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto flex w-full max-w-md flex-col gap-6 px-6 py-16 md:px-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="font-semibold font-mono text-xl underline underline-offset-2">Login</CardTitle>
        ...
        <p className="text-sm text-center hover:underline hover:underline-offset-2 cursor-pointer">Don't have an account? Sign up</p>
      </div>
    </div>
  )
}
