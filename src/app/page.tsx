    ...
    <div className="flex flex-col min-h-[100dvh]">
      <main className="flex-1">
        <section ref={ref1} className="w-full min-h-screen relative">
          ...
          >
            <div className="container px-4 md:px-6 flex justify-center items-center py-10 md:py-24">
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2 text-start w-full ">
                  <div className="w-[300px] md:w-[500px] absolute hidden md:block md:top-32 md:-right-0 -z-50">
                    <LottieComponent path="/rubiks-cube.json" />
                  </div>
                  <div className="w-[30px] md:w-[40px] absolute top-[42px] md:top-[97px] left-2 md:left-3 -z-50">
                    <LottieComponent path="/rounds-spinning.json" />
                  </div>
                  <h6 className="font-mono text-lg md:text-2xl ml-5 md:ml-6 text-green-500">Cubing Kerala,</h6>
                  ...
                  <p className="text-muted-foreground py-5 md:text-xl max-w-[850px]">
                  ...
                  <Button className="bg-green-400 text-black hover:bg-green-500 rounded-none">Get started</Button>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="container px-4 md:px-6">
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                ...
                <Button className="bg-green-400 text-black hover:bg-green-500 rounded-none">Competitions</Button>
              </div>
            </div>
          </motion.div>
        </section>
          ...
          <motion.div
            ...
            <div className="container px-4 md:px-6">
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                ...
                <Button className="bg-green-400 text-black hover:bg-green-500 rounded-none">Rankings</Button>
              </div>
            </div>
          </motion.div>
        </section>
            ...
            <div className="container px-4 md:px-6">
              <div className="grid gap-10 sm:px-10 md:gap-16 md:grid-cols-2">
                ...
                <div className="flex flex-col items-start space-y-4">
                  ...
                  <Button className="bg-green-400 text-black hover:bg-green-500 rounded-none">Join our Whatsapp group</Button>
                </div>
              </div>
            </div>
          </motion.div>
